...
//  -*- C++ -*-.
#ifndef CALOTOWERCOMBINEEXTRACT_H
#define CALOTOWERCOMBINEEXTRACT_H
...
class caloTowerCombineExtract : public SubsysReco
{
 public:
  caloTowerCombineExtract(const std::string &name = "caloTowerCombineExtract");

  ~caloTowerCombineExtract() override;
  ...
  void set_detector_type(caloTowerCombineExtract::DetectorSystem dettype)
  {
    m_dettype = dettype;
    return;
  }
 ...
 private:
  ...
  caloTowerCombineExtract::DetectorSystem m_dettype;
  ...
  std::string m_outputFileName = "caloTowerCombineExtractTree.root";
